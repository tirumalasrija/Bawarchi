    ...
    public function index($changes = ['all']) {
        ...
        if (empty($changes['load_defaults'])) {
            ...
            $fields = [
                ...
                'show_option_search' => new Zend_Db_Expr($db->quoteInto("COALESCE(`fge`.`show_option_search`, ?)", $this->configuration->getDefaultShowOptionSearch())),
            ];
        }
        else {
            $position = "-1";
            ...
            $fields = [
                ...
                'show_option_search' => new Zend_Db_Expr($db->quoteInto("?", $this->configuration->getDefaultShowOptionSearch())),
            ];
        }
